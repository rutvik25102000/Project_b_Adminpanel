...
const ProductCard = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 bg-white rounded-lg border border-gray-300">
        <h2 className="text-xl font-bold mb-4 text-center border-b border-gray-200 pb-2">Add Food Item</h2>
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            {/* Ingredients */}
            <div className="border border-gray-300 p-3 rounded col-span-2">
                <label className="block mb-2 border-b border-gray-200 pb-1">Ingredients</label>
            ...
            <div className="col-span-2">
                <input type="file" onChange={handleFileChange} accept="image/*" className="w-full p-2 border border-gray-300 rounded" required />
            </div>
